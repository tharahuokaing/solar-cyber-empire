...
function checkGpsRollover() {
    ...
    const shieldLogs = [
        "> ព្រះអធិរាជសារ៖ កំពុងសមកាលកម្មបណ្តាញផ្កាយរណប Saturn Rings Grid...",
        "> ស្ថានភាពបណ្តាញ៖ ផ្កាយរណបចំនួន ៨២ គ្រឿង កំពុងស្ថិតក្នុងគន្លងអធិរាជ...",
        "> របាំងថាមពល (Plasma Shield)៖ ដំណើរការស្ថិរភាព ៩៩.៩៩%",
        "> ការត្រួតពិនិត្យរលកសញ្ញា៖ មិនមានការជ្រៀតជ្រែកពីអាណាចក្រខាងក្រៅ...",
        "> ការវិភាគ៖ ដែនអាកាសអន្តរភពស្ថិតក្រោមការបិទខ្ទប់ដាច់ខាត!",
        "> ព្រះអធិរាជបញ្ជា៖ រក្សាវិន័យការពារ និងត្រៀមបាញ់កម្ទេចរាល់យានចម្លែក (UFO)!"
    ];
